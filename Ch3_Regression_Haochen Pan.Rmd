...
1st plot shows some non-linear relationship, the 2nd shows the residuals are normally distributed and right skewed, the 3rd and 4th means variance of errors are constant and there is leverage points in the data
~~~
